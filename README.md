...
- **kubectl-claude** — AI-powered multi-cluster Kubernetes management for Claude Code.
  Not yet available as a Homebrew formula; install via the
  [Claude Code plugin marketplace](https://github.com/kubestellar/claude-plugins) or from
  [source](https://github.com/kubestellar/kubectl-claude).
